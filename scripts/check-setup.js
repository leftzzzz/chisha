...
const requiredFiles = [
  ...
  { path: 'lib/agent/orchestrator/runtime.ts', description: '编排层执行器' },
  { path: 'lib/agent/orchestrator/policy.ts', description: '编排层唯一决策者' },
  { path: 'lib/agent/models/goalUnderstandingModel.ts', description: 'GoalUnderstandingModel' },
  { path: 'lib/agent/models/keywordExpansionModel.ts', description: 'KeywordExpansionModel' },
  { path: 'lib/agent/models/evaluationModel.ts', description: 'EvaluationModel' },
  { path: 'lib/agent/models/searchReplanModel.ts', description: 'ReplanModel' },
  { path: 'lib/agent/goal.ts', description: '目标代数（合并/打补丁/选项应用）' },
  { path: 'lib/agent/searchAttempts.ts', description: '搜索历史只读查询' },
